...
A token is used for authorizing a user 
2. What steps can you take in your web apps to keep your data secure?
Create token authorizations, route management, access control. 
3. Describe how web servers work.
Webs erver is a computer that runs websites. From storing, processing, and delivering web pages to users using HTTP.
